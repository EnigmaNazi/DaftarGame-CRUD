    ...
    public void RefreshList() {
        ...
        ListView01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                final CharSequence[] dialogitem = {"Lihat Data Game", "Update Data Game", "Hapus Data Game"};
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        switch (item) {
                            case 0:
                                ...
                                i.putExtra("nama_game", selection);
                                startActivity(i);
                                break;
                            case 1:
                                Intent in = new Intent(getApplicationContext(), UpdateActivity.class);
                                in.putExtra("nama_game", selection);
                                startActivity(in);
                                break;
                            case 2:
                                SQLiteDatabase db = dbcenter.getWritableDatabase();
                                db.execSQL("delete from game where nama_game = '" + selection + "'");
                                RefreshList();
                                break;
                        }
                    }
